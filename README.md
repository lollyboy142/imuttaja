This is a torrent ip sucking tool called in finnish language "ip imuttaja" that means ip sucker. To collect the ip addresses the user should press the button that says...
